...
enum opt_code
{
  ...
  OPT_mad = 1004,                            /* -mad */
  OPT_mandroid = 1005,                       /* -mandroid */
  OPT_march_ = 1006,                         /* -march= */
  OPT_mbionic = 1007,                        /* -mbionic */
  OPT_mbranch_cost_ = 1008,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1009,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1010,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1011,                /* -mcode-readable= */
  OPT_mcompact_eh = 1012,                    /* -mcompact-eh */
  OPT_mdebug = 1013,                         /* -mdebug */
  OPT_mdebugd = 1014,                        /* -mdebugd */
  OPT_mdivide_breaks = 1015,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1016,                  /* -mdivide-traps */
  OPT_mdmx = 1017,                           /* -mdmx */
  OPT_mdouble_float = 1018,                  /* -mdouble-float */
  OPT_mdsp = 1019,                           /* -mdsp */
  OPT_mdspr2 = 1020,                         /* -mdspr2 */
  OPT_meb = 1021,                            /* -meb */
  OPT_mel = 1022,                            /* -mel */
  OPT_membedded_data = 1023,                 /* -membedded-data */
  OPT_meva = 1024,                           /* -meva */
  OPT_mexplicit_relocs = 1025,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1026,                  /* -mextern-sdata */
  OPT_mfix_24k = 1027,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1028,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1029,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1030,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1031,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1032,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1033,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1034,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1035,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1036,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1037,                 /* -mfp-exceptions */
  OPT_mfp32 = 1038,                          /* -mfp32 */
  OPT_mfp64 = 1039,                          /* -mfp64 */
  OPT_mframe_header_opt = 1040,              /* -mframe-header-opt */
  OPT_mfused_madd = 1041,                    /* -mfused-madd */
  OPT_mglibc = 1042,                         /* -mglibc */
  OPT_mgp32 = 1043,                          /* -mgp32 */
  OPT_mgp64 = 1044,                          /* -mgp64 */
  OPT_mgpopt = 1045,                         /* -mgpopt */
  OPT_mhard_float = 1046,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1047,              /* -minterlink-mips16 */
  OPT_mips = 1048,                           /* -mips */
  OPT_mips16 = 1049,                         /* -mips16 */
  OPT_mips16e = 1050,                        /* -mips16e */
  OPT_mips3d = 1051,                         /* -mips3d */
  OPT_mjals = 1052,                          /* -mjals */
  OPT_mllsc = 1053,                          /* -mllsc */
  OPT_mlocal_sdata = 1054,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1055,                    /* -mlong-calls */
  OPT_mlong32 = 1056,                        /* -mlong32 */
  OPT_mlong64 = 1057,                        /* -mlong64 */
  OPT_mmcount_ra_address = 1058,             /* -mmcount-ra-address */
  OPT_mmcu = 1059,                           /* -mmcu */
  OPT_mmemcpy = 1060,                        /* -mmemcpy */
  OPT_mmicromips = 1061,                     /* -mmicromips */
  OPT_mmt = 1062,                            /* -mmt */
  OPT_mnan2008 = 1063,                       /* -mnan2008 */
  OPT_mno_float = 1064,                      /* -mno-float */
  OPT_mno_flush_func = 1065,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1066,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1067,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1068,                     /* -mno-mips3d */
  OPT_mocteon_useun = 1069,                  /* -mocteon-useun */
  OPT_mpaired_single = 1070,                 /* -mpaired-single */
  OPT_mplt = 1071,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1072,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1073,               /* -mrelax-pic-calls */
  OPT_mshared = 1074,                        /* -mshared */
  OPT_msingle_float = 1075,                  /* -msingle-float */
  OPT_msmartmips = 1076,                     /* -msmartmips */
  OPT_msoft_float = 1077,                    /* -msoft-float */
  OPT_msplit_addresses = 1078,               /* -msplit-addresses */
  OPT_msym32 = 1079,                         /* -msym32 */
  OPT_msynci = 1080,                         /* -msynci */
  OPT_mtune_ = 1081,                         /* -mtune= */
  OPT_muclibc = 1082,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1083,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1084,                  /* -mvr4130-align */
  OPT_mxgot = 1085,                          /* -mxgot */
  OPT_n = 1086,                              /* -n */
  OPT_no_canonical_prefixes = 1087,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1088,              /* -no-integrated-cpp */
  OPT_noasmopt = 1089,                       /* -noasmopt */
