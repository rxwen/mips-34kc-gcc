...
enum machine_mode
{
  ...
  CCV2mode,                /* config/mips/mips-modes.def:40 */
  CCV4mode,                /* config/mips/mips-modes.def:44 */
  CCDSPmode,               /* config/mips/mips-modes.def:49 */
  ...
  TFmode,                  /* config/mips/mips-modes.def:21 */
  ...
  V4QImode,                /* config/mips/mips-modes.def:24 */
  V2HImode,                /* config/mips/mips-modes.def:24 */
  V8QImode,                /* config/mips/mips-modes.def:25 */
  V4HImode,                /* config/mips/mips-modes.def:25 */
  V2SImode,                /* config/mips/mips-modes.def:25 */
  V16QImode,               /* config/mips/mips-modes.def:29 */
  V8HImode,                /* config/mips/mips-modes.def:30 */
  V4SImode,                /* config/mips/mips-modes.def:31 */
  V4QQmode,                /* config/mips/mips-modes.def:34 */
  V2HQmode,                /* config/mips/mips-modes.def:34 */
  V4UQQmode,               /* config/mips/mips-modes.def:35 */
  V2UHQmode,               /* config/mips/mips-modes.def:35 */
  V2HAmode,                /* config/mips/mips-modes.def:36 */
  V2UHAmode,               /* config/mips/mips-modes.def:37 */
  V2SFmode,                /* config/mips/mips-modes.def:26 */
  V4SFmode,                /* config/mips/mips-modes.def:32 */
  MAX_MACHINE_MODE,
